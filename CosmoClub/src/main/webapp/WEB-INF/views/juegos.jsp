    ...
    <div class="main-container d-flex">
      ...
      <div class="sidebar" id="side_nav">
        ...
        <ul class="list-unstyled px-5">
            ...
            <li class="active"><a href="/juegos" class="text-decoration-none px-3 py-2 d-block"><i class='bx bxs-invader' ></i> Juegos</a></li>
    ...
    <div class="content">
          ...
          <div class="container-fluid justify-content-between">
            ...
            <div class="dropdown dropstart">
              <a type="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <img class="img-nav rounded-circle-border-nav rounded-circle me-2" src="<c:url value='${user.user_img}'/>" alt="">
              </a>
        ...
        <div class="">
          <section class="d-flex-center">
            <h3 class="family-pixel text-uppercase">TODOS LOS JUEGOS</h3>
            <div class="d-flex rounded-5">
        
              <div class="card col-md-4 col-sm-12 rounded-5 me-3 border-0" style="width: 25rem;">
                <img src="img/juegos/space-ship.png" class="card-img-top img-cursos rounded-5 rounded-bottom-0 img-mycourses1" alt="img_curso">
                <div class="card-body d-flex flex-column align-items-center">
                  <h5 class="card-title text-center">Space-Ship</h5>
                  <p class="card-text mt-2 text-justify">Derriba las naves espaciales</p>
                  <a href="/juegos/spaceship" class="btn btn-primary w-50 border-0 rounded-pill ">JUGAR</a>
                </div>
              </div>
        
              <div class="card col-md-4 col-sm-12 rounded-5 me-3 border-0" style="width: 25rem;">
                <img src="img/juegos/puzzle.png" class="card-img-top img-cursos rounded-5 rounded-bottom-0 img-mycourses1" alt="img_curso">
                <div class="card-body d-flex flex-column align-items-center">
                  <h5 class="card-title text-center">Puzzle Espacial</h5>
                  <p class="card-text mt-2 text-justify">Descifra el puzzle</p>
                  <a href="/juegos/puzzleespacial" class="btn btn-primary w-50 border-0 rounded-pill ">JUGAR</a>
                </div>
              </div>
        
              <div class="card col-md-4 col-sm-12 rounded-5 me-3 border-0" style="width: 25rem;">
                <img src="img/juegos/pingpong.png" class="card-img-top img-cursos rounded-5 rounded-bottom-0 img-mycourses1" alt="img_curso">
                <div class="card-body d-flex flex-column align-items-center">
