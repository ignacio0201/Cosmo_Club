                ...
                <div class="card-3d-wrapper">
                    <div class="card-front" >
                            <form class="p-5" novalidate accept-charset="UTF-8" action="/login" method="POST">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="#" class="link-button" id="registerLink" data-replace="Registrate">Registrate</a>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card-back" >
                        <form:form class="p-5" accept-charset="UTF-8" action="/register" method="POST" modelAttribute="user">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <p>¿Ya tienes una cuenta? <a href="#" class="link-button" id="loginLink" data-replace="Inicia Sesión">Inicia Sesión</a></p>
                                    </div>
                        </form:form>
                    </div>
                </div>
