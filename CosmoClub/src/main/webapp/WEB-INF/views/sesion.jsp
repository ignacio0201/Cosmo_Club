                    ...
                    <div class="card-front">
                        <form class="p-5" novalidate accept-charset="UTF-8" action="/login" method="POST">
                                        ...
                                        <c:if test="${not empty loginError}">
                                            <div class="text-validation text-center mt-2">${loginError}</div>
                                        </c:if>
                    ...
                    <div class="card-back">
                        <form:form class="p-5" accept-charset="UTF-8" action="/register" method="POST" modelAttribute="user">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <form:errors class="text-validation" path="name" />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <form:errors class="text-validation" path="last_name" />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <form:errors class="text-validation" path="email" />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <form:errors class="text-validation" path="password" />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <form:errors class="text-validation" path="passwordConfirmation" />
                                            </div>
